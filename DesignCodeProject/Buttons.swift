...
struct PayButton: View {
	...
	var body: some View {
		...
		.overlay(
			Circle()
				.trim(from: tap ? 00.1 : 1, to: 1)
				.stroke(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.4804682136, green: 0.3520840704, blue: 1, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing), style: StrokeStyle(lineWidth: 5, lineCap: .round))
